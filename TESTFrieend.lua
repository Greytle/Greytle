...
--[[
LefRocks - The Big Black - Lost Soul
💮Hajimeslvr💮
OuterSpacePirate - Legendary
Ruined - Th1rt3en
...
--2699922745
local modeInfo={
	{Name="LefRocks",Walkspeed=16,moveVal=8,Font=Enum.Font.Arcade,StrokeColor=C3.N(.5,.5,.5);Music=2533527428,LeftWing={0,BrickColor.new'Shamrock'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Shamrock'.Color,Enum.Material.Neon};WingAnim='NebG1'};
	{Name="💮Hajimeslvr💮",Walkspeed=16,moveVal=8,Font=Enum.Font.Garamond,StrokeColor=C3.N(.2,.2,.2);Music=6550180298,LeftWing={0,BrickColor.new'Maroon'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Maroon'.Color,Enum.Material.Neon};WingAnim='NebG1'};
	{Name="OuterSpacePirate",Walkspeed=24,moveVal=10,Font=Enum.Font.Fantasy,StrokeColor=C3.N(.6,.0,.9);Music=212675193,LeftWing={0,BrickColor.new'Cyan'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Cyan'.Color,Enum.Material.Neon};WingAnim='StarG'};
	...
	{Name="MaxiS",Walkspeed=16,moveVal=8,Font=Enum.Font.Gotham,StrokeColor=C3.RGB(98,37,209);Music=603291385,LeftWing={0,BrickColor.new'Dark indigo'.Color,Enum.Material.DiamondPlate};RightWing={0,BrickColor.new'Dark indigo'.Color,Enum.Material.DiamondPlate};WingAnim='NebG1'};	
	{Name="Love",Walkspeed=16,moveVal=8,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(255,152,220);Music=4772184716,LeftWing={0,BrickColor.new'Pink'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Pink'.Color,Enum.Material.Neon};WingAnim='StarG'};
	--MAJORS--
...
UIS.InputBegan:connect(function(io,gpe)
	...
	--MODES
	if(io.KeyCode == Enum.KeyCode.One and Mode~='LefRocks')then 
		changeMode'LefRocks'
	elseif(io.KeyCode == Enum.KeyCode.Two and Mode~='💮Hajimeslvr💮')then 
		changeMode'💮Hajimeslvr💮'
	elseif(io.KeyCode == Enum.KeyCode.Three and Mode~='OuterSpacePirate')then 
		changeMode'OuterSpacePirate'
	...
	elseif(io.KeyCode == Enum.KeyCode.Nine and Mode~='Love')then 
		changeMode'Love'
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='LefRocks')then 
		changeMode'The Big Black'
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='OuterSpacePirate')then 
...
while true do
	...
	if(State == 'Idle')then
		...
		elseif(Mode=='OuterSpacePirate')then
			local Alpha = .1
			if(NeutralAnims)then	
				GotEffect{
					Lifetime=.5;
