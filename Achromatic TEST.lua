...
local modeInfo={
	...
	{Name="Lustful",Walkspeed=16,moveVal=8,Font=Enum.Font.Fantasy,StrokeColor=C3.N(1,0,1);Music=1837447284,LeftWing={0,BrickColor.new'Eggplant'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Eggplant'.Color,Enum.Material.Neon};WingAnim='LustfulFrench'};
...
function changeMudo(modeName)
	...
	text.Font=info.Font;
	if(Mode=='Love' or Mode=='Lustful')then
...
WingAnims.LustfulFrench=function()
...
while true do
	...
	if(Mode~='Lustful' and WingAnim and WingAnims[WingAnim])then
		WingAnims[WingAnim]()
	elseif(Mode=='Lustful')then
		if(State=='Idle')then
			WingAnims.LustfulFrench()
		else
			WingAnims.NebG3(1)	
		end
